...
import { usePurchasesOrderDetail } from './hooks';
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold">Rincian Pembelian</h1>
        ...
        {success && (
          <div className="text-green-600 bg-green-100 p-4 rounded-md flex items-start gap-4">
            ...
            <p>Transaksi pembelian berhasil disimpan!</p>
          </div>
        )}
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="flex items-center gap-2 text-sm">
            ...
            <span className={cn(isPaid ? 'text-green-600' : 'text-red-800')}>
              {isPaid ? `LUNAS` : `Hutang ${formatCurrency(receivable)}`}
            </span>
          </p>
        </div>
      </div>
